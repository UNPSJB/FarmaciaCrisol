...
class Ui_vtnPrincipal(object):
    def setupUi(self, vtnPrincipal):
        ...
        self.menuPresentaci_n = QtGui.QMenu(self.menuProducto)
        self.menuPresentaci_n.setObjectName(_fromUtf8("menuPresentaci_n"))
        ...
        self.menuPresentaci_n.addAction(self.actionAltaPresentacion)
        self.menuPresentaci_n.addSeparator()
        self.menuPresentaci_n.addAction(self.actionBajaPresentacion)
        self.menuPresentaci_n.addSeparator()
        self.menuPresentaci_n.addAction(self.actionModificarPresentacion)
        ...
        self.menuProducto.addSeparator()
        self.menuProducto.addAction(self.menuPresentaci_n.menuAction())
        self.menuProducto.addSeparator()
    ...
    def retranslateUi(self, vtnPrincipal):
        ...
        self.menuPresentaci_n.setTitle(_translate("vtnPrincipal", "Presentación", None))
        ...
        self.actionListar.setText(_translate("vtnPrincipal", "Genrar Listado", None))
