...
class Ui_vtnBajaProducto(object):
    def setupUi(self, vtnBajaProducto):
        ...
        self.txtCodBarra = QtGui.QLineEdit(vtnBajaProducto)
        self.txtCodBarra.setObjectName(_fromUtf8("txtCodBarra"))
        self.gridLayout.addWidget(self.txtCodBarra, 0, 1, 1, 1)
        ...
        vtnBajaProducto.setTabOrder(self.txtCodBarra, self.pushButton)
    ...
    def retranslateUi(self, vtnBajaProducto):
        ...
        self.txtCodBarra.setAccessibleDescription(_translate("vtnBajaProducto", "codigo", None))
