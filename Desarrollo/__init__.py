...
class MdiWidget(QtGui.QWidget):
    ...
    def validarDatos(self, txt):
        txt.textChanged.connect(self.contenido(txt))

    def contenido(self, txt):
        pass
...
class AltaProducto(MdiWidget, Ui_vtnAltaProducto):
    def __init__(self, mdi):
        ...
        self.validarDatos(self.txtNomb)
        self.validarDatos(self.txtTipo)
        self.validarDatos(self.txtCodBarra)
        self.validarDatos(self.txtImp)
