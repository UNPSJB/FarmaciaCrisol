...
class Ui_vtnModificarLote(object):
    def setupUi(self, vtnModificarLote):
        ...
        self.label_3 = QtGui.QLabel(vtnModificarLote)
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.gridLayout.addWidget(self.label_3, 2, 0, 1, 1)
        self.lineEdit_2 = QtGui.QLineEdit(vtnModificarLote)
        ...
        vtnModificarLote.setTabOrder(self.tableWidget, self.lineEdit_2)
        vtnModificarLote.setTabOrder(self.lineEdit_2, self.dateEdit)
    ...
    def retranslateUi(self, vtnModificarLote):
        ...
        self.label_3.setText(_translate("vtnModificarLote", "Número", None))
