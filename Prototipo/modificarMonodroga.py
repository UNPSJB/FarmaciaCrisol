...
class Ui_vtnModificarMonodroga(object):
    def setupUi(self, vtnModificarMonodroga):
        ...
        self.lineEdit_2 = QtGui.QLineEdit(vtnModificarMonodroga)
        ...
        self.gridLayout.addWidget(self.label_3, 5, 0, 1, 1, QtCore.Qt.AlignTop)
        ...
        vtnModificarMonodroga.setTabOrder(self.tableWidget, self.lineEdit_2)
        vtnModificarMonodroga.setTabOrder(self.lineEdit_2, self.checkBox)
    ...
    def retranslateUi(self, vtnModificarMonodroga):
        ...
        self.label_2.setText(_translate("vtnModificarMonodroga", "Nombre", None))
