...
class Ui_vtnFraccionarProducto(object):
    def setupUi(self, vtnFraccionarProducto):
        ...
        self.formLayout.setWidget(3, QtGui.QFormLayout.SpanningRole, self.tablaProducto)
        ...
        self.formLayout_2 = QtGui.QFormLayout(self.gbFraccionable)
        ...
        self.formLayout_2.setWidget(0, QtGui.QFormLayout.SpanningRole, self.tablaFraccionable)
