...
class Ui_vtnAjusteNegativoStock(object):
    def setupUi(self, vtnAjusteNegativoStock):
        ...
        vtnAjusteNegativoStock.resize(658, 369)
        ...
        self.formLayout = QtGui.QFormLayout(self.gbProducto)
        ...
        self.formLayout.setWidget(1, QtGui.QFormLayout.SpanningRole, self.gbLote)
        ...
        self.formLayout.setWidget(2, QtGui.QFormLayout.SpanningRole, self.tablaLoteProducto)
        ...
        self.formLayout.setLayout(4, QtGui.QFormLayout.FieldRole, self.horizontalLayout_8)
