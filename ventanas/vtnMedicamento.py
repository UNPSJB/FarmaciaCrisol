...
class Ui_vtnMedicamento(object):
    def setupUi(self, vtnMedicamento):
        ...
        self.formLayout = QtGui.QFormLayout(self.gbMedicamento)
        ...
        self.formLayout.setWidget(1, QtGui.QFormLayout.SpanningRole, self.tablaMedicamento)
        ...
        self.formLayout_2 = QtGui.QFormLayout(self.gbMonodroga)
        ...
        self.formLayout_2.setWidget(1, QtGui.QFormLayout.SpanningRole, self.tablaMonodroga)
