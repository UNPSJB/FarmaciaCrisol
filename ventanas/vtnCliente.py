...
#
# Created: Fri Nov 14 15:23:00 2014
...
class Ui_vtnCliente(object):
    def setupUi(self, vtnCliente):
        ...
        self.formLayout.setWidget(3, QtGui.QFormLayout.FieldRole, self.lineDireccion)
        ...
        self.formLayout.setWidget(6, QtGui.QFormLayout.SpanningRole, self.groupBuscar)
        ...
        self.formLayout.setWidget(4, QtGui.QFormLayout.FieldRole, self.lineTelefono)
        ...
        vtnCliente.setTabOrder(self.lineApellido, self.lineDireccion)
    ...
    def retranslateUi(self, vtnCliente):
        ...
        self.groupBuscar.setTitle(_translate("vtnCliente", "Clientes que cumplen con el criterio de busqueda", None))
        ...
        item.setText(_translate("vtnCliente", "Telefono", None))
